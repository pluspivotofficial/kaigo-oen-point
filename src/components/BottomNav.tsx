import { Home, CalendarDays, Coins, Users, MessageCircleQuestion, User } from "lucide-react";
...
const BottomNav = () => {
  ...
  return (
    <nav data-tour="bottom-nav" className="fixed bottom-0 left-0 right-0 bg-card border-t border-border z-50">
